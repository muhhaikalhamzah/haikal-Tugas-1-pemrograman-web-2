<x-app>
    ...
    <form method="POST" action="{{ route('databantuan.update', $databantuan) }}">
        @csrf
        @method('PUT')
            ...
            <div class="card-body p-5">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('nokk') is-invalid @enderror " name="nokk"
                        value="{{ old('nokk', $databantuan->nokk) }}">
                    @error('nokk')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('namapenerima') is-invalid @enderror"
                        name="namapenerima" value="{{ old('namapenerima', $databantuan->namapenerima) }}">
                    @error('namapenerima')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <select class="form-select" name="jeniskelamin"
                        value="{{ old('jeniskelamin', $databantuan->jeniskelamin) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat"
                        value="{{ old('alamat', $databantuan->alamat) }}">
                    @error('alamat')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('pekerjaan') is-invalid @enderror" name="pekerjaan"
                        value="{{ old('pekerjaan', $databantuan->pekerjaan) }}">
                    @error('pekerjaan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('keterangan') is-invalid @enderror"
                        name="keterangan" value="{{ old('keterangan', $databantuan->keterangan) }}">
                    @error('keterangan')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
